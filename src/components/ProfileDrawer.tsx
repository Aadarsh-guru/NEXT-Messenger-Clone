...
import ConfirmModel from "./conversations/ConfirmModel";
import AvatarGroup from "./conversations/AvatarGroup";
                                                            ...
                                                            {!data?.isGroup && (
                                                                <>
                                                                    ...
                                                                    <div className="">
                                                                        ...
                                                                        <dd
                                                                            className="mt-1 text-sm text-neutral-900 sm:col-span-2"
                                                                        >
